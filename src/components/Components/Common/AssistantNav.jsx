...
export default function AssisstantNav({ asisten, permission_name = [], roleName }) {
    ...
    return (
        <>
            <nav className="relative z-20 flex h-screen items-start">
                <div
                ...
                >
                    ...
                    <div className="mt-[-1rem] flex min-h-0 flex-1 flex-col justify-between overflow-hidden">
                        ...
                        <ul className={`flex flex-shrink-0 flex-col gap-1 border-t border-depth/60 py-6 ${isCollapsed ? "px-1" : "px-4"}`}>
            ...
            <ModalLogout
                ...
                logoutAction={logoutAssistantSession}
                onLogoutSuccess={() => {
